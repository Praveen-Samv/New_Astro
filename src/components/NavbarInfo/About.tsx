...
//       {/* Main Section */}
//       <div className="container mx-auto py-24 px-16 flex flex-col  lg:flex-row gap-48 items-start">
//         {/* Image Section */}
...
//         <h2 className="text-[#C75807] text-[40px] font-bold leading-[24px] mb-6 mr-24 whitespace-nowrap text-center">
//         Mr. Tamual Rathi
//       </h2>
...
//         className="w-[323px] h-[18px] object-cover ml-48 mb-6"
//         alt="Underline"
//       />
//           <p className="text-gray-800 text-lg mt-22 mr-24 leading-7">
...
//       <div className="container mx-auto py-12 px-6 flex flex-col lg:flex-row gap-36 items-start">
  ...
  return (
    <div className="w-full bg-white min-h-screen">
      ...
      <div
        ...
        style={{
          backgroundImage:
            "url('https://image-resource.creatie.ai/145721118291381/145721118291383/66ea4685e864e08f190bd9ac09179cf6.jpg')",
        }}
      >
        <div className="text-white text-xl md:text-2xl font-medium flex items-center gap-4">
          <span className="text-3xl sm:text-4xl mt-16">About US</span>
        </div>
      </div>

      {/* Main Section */}
      <div className="container mx-auto py-12 sm:py-24 px-4 sm:px-16 flex flex-col lg:flex-row gap-12 lg:gap-48 items-start">
        {/* Image Section */}
        <div className="flex-shrink-0 mx-auto lg:-ml-16">
          <div className="relative">
            <img
              src="https://image-resource.creatie.ai/146256977394650/146256977394652/799f87b7b858138e22480b8d6fb642c1.png"
              alt="Astro"
            ...
            />
            <img
              src="https://image-resource.creatie.ai/146256977394650/146256977394652/707af02e68e6faf61f4bf2c2c92a4ea6.png"
              alt="Sun"
      ...
      {/* Mr. Tamual Rathi Section */}
      <div className="container mx-auto py-12 px-4 sm:px-6 flex flex-col lg:flex-row gap-12 items-start">
        {/* Text Section */}
        <div className="flex-1 mx-auto lg:-ml-16">
          <h2 className="text-[#C75807] text-3xl sm:text-[40px] font-bold leading-[24px] mb-6 text-center lg:text-left">
            Mr. Tamual Rathi
          </h2>
          {/* Underline */}
          <img
        ...
        <div className="flex-shrink-0 mx-auto">
          <div className="relative">
            ...
            />
            <img
              src="https://image-resource.creatie.ai/145721118291381/145721118291383/2fe61fbdaadbdff1506609fcea528dfb.png"
              alt="Sun"
      ...
      {/* Mr. Anachal Rathi Section */}
      <div className="container mx-auto py-12 px-4 sm:px-6 flex flex-col lg:flex-row gap-12 lg:gap-36 items-start">
        {/* Image Section */}
        <div className="flex-shrink-0 mx-auto">
          <h2 className="text-[#C75807] text-3xl sm:text-[40px] font-bold leading-[24px] mb-6 text-center">
            Mr. Anachal Rathi
          </h2>
          {/* Underline */}
          <img
            src="https://image-resource.creatie.ai/146256977394650/146256977394652/dc645f8e9ad238de31610a43d734a52f.webp"
            className="w-[200px] sm:w-[323px] h-[12px] sm:h-[18px] object-cover mx-auto mb-6"
            alt="Underline"
          />
          <div className="relative">
            <img
              src="https://image-resource.creatie.ai/146256977394650/146256977394652/799f87b7b858138e22480b8d6fb642c1.png"
              alt="Astro"
              className="w-full max-w-sm mt-12 sm:mt-16 animate-spin"
              style={{ animation: "spin 5s linear infinite" }}
            />
            <img
              src="https://corpastro.com/wp-content/uploads/2024/08/Aanchal-Raathi-astro-1.png"
              alt="Sun"
              className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2"
            />
          </div>
