...
const Contact: React.FC = () => {
  ...
  return (
    <div className="w-full bg-white overflow-hidden">
      ...
      >
        <div className="flex flex-col items-center justify-center h-full text-white">
          <h1 className="text-4xl font-bold mt-16 text-center">Contact Us</h1>
        </div>
      </div>
      ...
      {/* Google Map Section */}
      <div className="max-w-screen-lg mx-auto p-6 md:p-8">
        <h3 className="text-orange-600 text-xl font-medium mb-4 text-center md:text-left">Our Location</h3>
        <LoadScript googleMapsApiKey="AIzaSyA9qviqi7tO8nndT6WAP_O5qr3NrfpILl0">
          <GoogleMap
            mapContainerStyle={mapContainerStyle}
            center={defaultCenter}
