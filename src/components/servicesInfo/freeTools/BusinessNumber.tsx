  ...
  return (
    <div className="min-h-screen bg-white flex flex-col items-center p-4">
      ...
      <div className="w-screen bg-cover h-48 bg-center bg-[url('https://image-resource.creatie.ai/145720426227716/145720426227718/66ea4685e864e08f190bd9ac09179cf6.jpg')] p-6 sm:p-12 text-white text-center">
        <h1 className="text-2xl sm:text-4xl font-bold">Brand Number Calculator</h1>
      </div>

      {/* Image Card */}
      {/* <div className="w-full max-w-[90%] md:max-w-2xl p-4">
        <div className="w-full h-48 rounded-lg  shadow-lg overflow-hidden">
          <img
            src="https://image-resource.creatie.ai/146256977394650/146256977394652/ba00544ebfe83441a6f96a93469469d6.png"
            alt="Numerology"
      ...
      {/* Input Section */}
      <div className="w-full max-w-[90%] md:max-w-2xl p-4">
        <div className="text-lg font-bold text-gray-800 mb-4 text-center md:text-left">
          Fill the below details
        </div>
        <div className="w-full">
          <div className="mb-4">
