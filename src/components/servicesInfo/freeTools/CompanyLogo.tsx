...
const CompanyLogo: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-white flex flex-col items-center p-4">
      ...
      {/* Full Width Header Section */}
      <div className="w-screen bg-cover h-48 bg-center bg-[url('https://image-resource.creatie.ai/145720426227716/145720426227718/66ea4685e864e08f190bd9ac09179cf6.jpg')] p-6 sm:p-12 text-white text-center">
        <h1 className="text-2xl sm:text-4xl font-bold">Company Logo Suggestion</h1>
      </div>

      {/* Description Section */}
      <div className="w-full max-w-[95%] sm:max-w-2xl p-4">
      ...
      {/* Input Section */}
      <div className="w-full max-w-[95%] sm:max-w-2xl p-4">
        <div className="text-lg font-bold text-gray-800 mb-4 text-center sm:text-left">
          Fill the below details
        </div>
        <div className="w-full space-y-4">
          <div>
      ...
      {logoSuggestions.length > 0 && (
        <div className="w-full max-w-[95%] sm:max-w-2xl p-4">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
            {logoSuggestions.map((logo, index) => (
              <div key={index} className="w-full h-auto rounded-lg shadow-lg overflow-hidden">
                <img
                  src={logo}
                  alt={`Logo Suggestion ${index + 1}`}
