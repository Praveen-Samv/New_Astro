...
const PremiumServices = () => {
    return (
        <div className="w-full bg-white">
            {/* Breadcrumb */}
            <div
                className="w-full h-40 sm:h-52 bg-cover bg-center"
                style={{
                    backgroundImage:
                        "url(https://image-resource.creatie.ai/145720426227716/145720426227718/66ea4685e864e08f190bd9ac09179cf6.jpg)",
                }}
            >
                <div className="flex flex-col items-center justify-center h-full text-white pt-10 sm:pt-0">
                    <h1 className="text-2xl sm:text-4xl font-bold text-center">Premium Services</h1>
                    <div className="flex items-center space-x-2 text-sm sm:text-lg mt-2">
                        {/* Add breadcrumb links here if needed */}
                    </div>
                </div>
            </div>
