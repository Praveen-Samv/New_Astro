...
const AstroPremium = () => {
  ...
  return (
    <div className="w-full overflow-hidden py-12 bg-gray-100">
      ...
      <div
        ref={scrollRef}
        className="flex items-start gap-4 sm:gap-6 overflow-x-auto no-scrollbar px-4 sm:px-6"
      >
        {cards.map((card) => (
          <div
            key={card.id}
            className="relative w-[280px] sm:w-[350px] lg:w-[400px] h-[180px] sm:h-[220px] lg:h-[260px] flex-shrink-0 rounded-lg overflow-hidden"
          >
            {/* Card Image */}
            <img
              src={card.image}
